...
https://www.youtube.com/watch?v=iybATqk6LNI
...
def group_by_centroid(restaurants, centroids):
    ...
    """
    # BEGIN Question 4
    return group_by_key([[find_closest(restaurant_location(restaurant), centroids), restaurant] for restaurant in restaurants])
    # END Question 4
...
def rate_all(user, restaurants, feature_fns):
    ...
    reviewed = user_reviewed_restaurants(user, restaurants)
    # BEGIN Question 9
    rest_names = [restaurant_name(r) for r in restaurants]
    pred_rest_ratings = [predictor(r) for r in restaurants] 
    ...
    user_rest_ratings = [user_score(user, name) for name in reviewed_names]  
